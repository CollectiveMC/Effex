...
public class SpringEnchantment extends CustomEnchantment implements AmbientEffect, Enchanted
{
	private double pow = 0.27;
	public SpringEnchantment()
	{
		super("Spring", Matte.concat(Matte.boots()));
		
		setMaxLevel(1);
		setBase(5);
		setInterval(30);
		description = "Jump Boost (Boots)";
	}
