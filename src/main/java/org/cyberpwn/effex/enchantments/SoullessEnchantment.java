...
public class SoullessEnchantment extends CustomEnchantment implements AmbientEffect, Enchanted
{
	private double pow = 0.06;
	public SoullessEnchantment()
	{
		super("Soulless", Matte.armor());
		
		setMaxLevel(1);
		setBase(5);
		setInterval(8);
		description = "Prevent those from decapitating you (Armor)";
	}
