...
public class ColdBloodedEnchantment extends CustomEnchantment implements AmbientEffect, Enchanted
{
	private double pow = 0.21;
	public ColdBloodedEnchantment()
	{
		super("Cold Blooded", Matte.concat(Matte.armor()));
		
		setMaxLevel(1);
		setBase(5);
		setInterval(8);
		description = "Immunity to Heat Seaking Arrows (Armor)";
	}
